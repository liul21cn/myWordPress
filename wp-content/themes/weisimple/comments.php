		...
		<div class="comt">
			...
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					...
					<div class="position">
                  <a href="javascript:;" id="comment-smiley" title="插入表情"><b><i class="fa fa-smile-o"></i></b> 表情</a>
				...
				<?php if( get_option('require_name_email') ){ ?>
					<div class="comt-comterinfo" id="comment-author-info" <?php if ( !empty($comment_author) ) echo 'style="display:none"'; ?>>
						<ul>
							...
							<input id="comt-qq" class="ipt" name="new_field_qq" type="text" value="" placeholder="QQ号(快速填写信息)" /></li>
							<li class="form-inline"> 
							...
							<input class="ipt" type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" tabindex="4" placeholder="网址(选填)"></li>
						</ul>
					</div>
				<?php } ?>
			<?php } ?>
