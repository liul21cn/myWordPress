...
$email_bg =get_stylesheet_directory_uri() .'/img/email.jpg';
...
$email_headertop = '
    <div class="emailpaged" style="background-image: url('.emailbg.');-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;background-position: center center;background-repeat: no-repeat;">
        <div class="emailcontent" style="width:100%;max-width:720px;text-align: left;margin: 0 auto;padding-top: 1px;padding-bottom: 20px">
            <div class="emailtitle">
                <h1 style="color:#fff;background: #51a0e3;line-height:50px;font-size:20px;font-weight:normal;padding-left:40px;margin:0">
';
...
function wp_login_failed_notify(){
    ...
    $message =  emailheadertop . get_bloginfo('name') . '账户登录失败通知！'.emailheaderbot.'
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border-top:1px solid #eee;border-left:1px solid #eee;color:#6e6e6e;font-size:14px;font-weight:normal">
                ...
                <tbody>
				    ...
				    <tr>
                     ...
                     <tr>
                        <td style="padding:10px 0;border-right:1px solid #eee;border-bottom:1px solid #eee;text-align:center;">登录所在地</td>
                        <td style="padding:10px 20px 10px 30px;border-right:1px solid #eee;border-bottom:1px solid #eee;line-height:30px">' . convertip($_SERVER['REMOTE_ADDR']) . '</td>
                    </tr>
				    <tr>
