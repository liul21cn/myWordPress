	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="entry-content">
						...
						<div class="xiaoshi">
							<div class="single_banquan">	
								...
								<strong>关注我们：</strong>请关注一下我们的微信公众号：<a class="iboke112" href="JavaScript:void(0)">扫描二维码<span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/gongzhonghao.jpg" alt="<?php bloginfo('name'); ?>的公众号"></span></a>，公众号：aiboke112<br/>
								<?php if ( get_post_meta($post->ID, 'tgwz', true) ) : ?>
				...
				<?php if (get_option('ygj_taobaowz')) { get_template_part('/inc/taobao'); } ?>				
