...
$options = array(
	...
	array(  "name" => "<span style='color:#C01E22'>公告栏开关</span>",
			"desc" => "说明：默认不开启，开启后将在首页导航下方显示滚动公告栏",
			"id" => "ygj_ggl_kg",
			"type" => "checkbox"),
	
	array(	"name" => "<span style='color:#C01E22'>首页公告栏内容</span>",
    ...
    array(
        'name'  => '文章版权声明',
        'desc'  => '建议直接修改Nana主题的single.php文件55-67行的文字，参数不建议修改。PS:以下为版权格式（投稿和转载文章类似）',
        'id'    => "ygj_copyright",
        'type'  => 'textarea',
        'std'   => '投稿文章版权格式：
...
版权声明：本文为转载文章，来源于 文章作者 ，版权归原作者所有，如有侵权请留言告知，谢谢合作！'
	...
	array(	"name" => "首页双栏分类ID设置",
			"desc" => "说明：必须是两个分类及以上(每个分类最好有10篇文章及以上)，显示更多分类请用英文逗号＂,＂隔开",
            "id" => "ygj_catldt",
            "type" => "text",
            "std" => "1"),
	...
	array(	"name" => "首页单栏分类ID设置",
			"desc" => "说明：显示更多分类(每个分类最好有10篇文章及以上)，请用英文逗号＂,＂隔开",
            "id" => "ygj_catld",
            "type" => "text",
            "std" => "1"),
    ...
    array(  "name" => "<span style='color:#C01E22'>导航栏下方广告</span>",
			"desc" => "说明：默认显示，首页通栏显示",
            "id" => "ygj_ddad",
            "type" => "select",
            "std" => "显示",
	...
	array(  "name" => "<span style='color:#C01E22'>首页(列表页)第一广告</span>",
			"desc" => "说明：默认显示",
            "id" => "ygj_adh",
            "type" => "select",
            "std" => "关闭",
	...
	array(  "name" => "<span style='color:#C01E22'>首页（列表页）第二广告</span>",
	...
	array(  "name" => "<span style='color:#C01E22'> 正文标题下方广告 </span>",
			"desc" => "说明：默认显示",
            "id" => "ygj_g_single",
            "type" => "select",
            "std" => "关闭",
	...
	array(  "name" => "<span style='color:#C01E22'>正文底部广告</span>",
			"desc" => "说明：默认显示",
            "id" => "ygj_adt",
            "type" => "select",
            "std" => "关闭",
	...
	array(  "name" => "<span style='color:#C01E22'>评论框上方广告</span>",
			"desc" => "说明：默认显示",
            "id" => "ygj_g_comment",
            "type" => "select",
            "std" => "关闭",
	...
	array(  "name" => "<span style='color:#C01E22'>通栏页面评论框上方广告</span>",
			"desc" => "说明：默认显示",
            "id" => "ygj_g_full",
            "type" => "select",
            "std" => "关闭",
	...
	array(	"name" => "<span style='color:#C01E22'>下载弹窗广告</span>",
    ...
    array(
        'name'  => '加密WordPress后台',
        'desc'  => '启用之后，请填写下面的问题与答案，默认后台登录地址将变为：http://yoursite/wp-login.php?问题=答案。<a class="button-primary" href="https://www.yigujin.cn/997.html" target="_blank">忘记路径解决办法</a>',
        'id'    => "ygj_admin_link",
        'type'  => 'checkbox'
    ),
    array(
...
<div class="wrap">
    ...
    <div class="ygjtips">    
    <p>当前主题:Nana&nbsp;3.3&nbsp;版 | 设计者：<a href="https://www.yigujin.cn/" target="_blank">懿古今</a> | <a href="https://www.yigujin.cn/987.html" target="_blank">加入懿古今主题交流群（477678587）</a> | <a href="https://www.yigujin.cn/722.html" target="_blank">赞助20元去版权</a> | 申请免费收录到 <a href="https://boke112.com/" target="_blank">boke112导航</a> </p>
    </div>
	<?php //获取所有站点分类id
...
function ygj_pointer_print_scripts() {
    ...
    jQuery(document).ready(function($) {
        ...
        $menuAppearance.pointer({
            content: '<h3>恭喜，Nana 主题3.3安装成功！</h3><p>该主题支持选项，请访问<a href="themes.php?page=theme-options.php">主题选项</a>页面进行配置。</p>',
            position: {
                edge: "left",
                align: "center"
            },
